...
const Hero = () => {
  return (
    <section className="mx-3 md:mx-12 mt-3 md:mt-6 py-8 md:py-16">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col justify-between items-center gap-4 text-center py-4">
          <img
            src={avatar}
            alt="avatar"
            className="rounded-full w-28 h-28 md:w-32 md:h-32 border-4 border-eefSecondary"
          />
          ...
          <div className="mt-8 flex justify-center gap-4">
            <a
              ...
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-eefLight bg-eefPrimary hover:bg-eefDark"
            >
              GitHub
            ...
            <a
              ...
              className="inline-flex items-center px-6 py-3 border border-eefDark text-base font-medium rounded-md text-eefDark bg-eefLight hover:bg-eefSecondary"
            >
              LinkedIn
